document.getElementById('incidents').addEventListener('mouseenter', getAllIncidents);

function getAllIncidents(e){
  e.preventDefault();
  ...
  .then((data) => {
    ...
    if (data.Error){
        ...
        let output = `<h2>All Incidents</h2>`;
        ...
        document.getElementById('incidents').removeEventListener('mouseenter', getAllIncidents);
